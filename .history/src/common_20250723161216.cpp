...
/*************  ✨ Windsurf Command ⭐  *************/
/**
 * Initializes device memory with random values between -50.0 and 50.0.
 *
 * @param[in] d_ptr device pointer to initialize
 * @param[in] N number of elements to initialize
 */
/*******  62149939-ac73-4023-9c55-17994015bdff  *******/
