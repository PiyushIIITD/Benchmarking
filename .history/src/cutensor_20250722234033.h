 ...
 *
 * @param[in] d_in Input tensor
 * @param[out] d_out Output tensor
 * @param[in] N Number of elements in the input tensor
 */
/*******  587e9a72-5f11-42d1-a305-6f08d8eafe2d  *******/    *desc = 1; return 0;
}
