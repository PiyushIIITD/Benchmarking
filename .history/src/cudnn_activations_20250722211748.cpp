// activations_cudnn.cpp
#include "common.h"

// Global cuDNN handle (defined in main.cpp)
extern cudnnHandle_t g_cudnnHandle;

// Create a tensor descriptor for 1D data (as NCHW with C=H=W=1)
void createTensorDescriptor(cudnnTensorDescriptor_t& descriptor, size_t N) {
    ...
    CUDNN_CHECK(cudnnSetTensor4dDescriptor(
        ...
        CUDNN_TENSOR_NCHW,
        CUDNN_DATA_FLOAT,
        static_cast<int>(N), 1, 1, 1  // N, C, H, W
    ));
}
